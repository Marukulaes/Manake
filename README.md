...
local library = loadstring(game:HttpGet('https://raw.githubusercontent.com/Marukulaes/ManakeGui.lua/main/README.md'))()
local Wait = library.subs.Wait

local PepsisWorld = library:CreateWindow({
	Name = "Manake X Hub | Free Script",
	Themeable = {
		Info = "Discord Server: Manake X Hub"
	}
})
...
local WorldSection = MainTab:CreateSection({
	Name = "World",
	Side = "Left"
})
...
if World1 then
	...
	local MaterialsSection = MainTab:CreateSection({
		Name = "Materials",
		Side = "Left"
	})

	MaterialsSection:AddToggle{
...
elseif World2 then
	...
	EctoplasmSection:AddToggle{
		Name = "Auto Ectoplasm Hop",
		Flag = "Auto_Ectoplasm_Hop",
		Value = _G.Settings.Auto_Farm_Ectoplasm,
		Callback  = function(value)
			Wait(2)
			local module = loadstring(game:HttpGet"https://raw.githubusercontent.com/LeoKholYt/roblox/main/lk_serverhop.lua")()
	...
	local RengokuSection = MainTab:CreateSection({
		Name = "Rengoku",
		Side = "Left"
	})

	RengokuSection:AddToggle{
		Name = "Auto Rengoku",
		Flag = "Auto_Rengoku",
	...
	local EvoRaceSection = MainTab:CreateSection({
		Name = "Evo Race",
		Side = "Left"
	})

	EvoRaceSection:AddToggle{
		Name = "Auto Evo Race",
	...
	local DragonTridentSection = MainTab:CreateSection({
		Name = "Dragon Trident",
		Side = "Left"
	})

	DragonTridentSection:AddToggle{
	...
	local LegendarySwordSection = MainTab:CreateSection({
		Name = "Legendary Sword",
		Side = "Left"
	})

	LegendarySwordSection:AddToggle{
...
elseif World3 then
	...
	local SoulReaperSection = MainTab:CreateSection({
		Name = "Soul Reaper",
		Side = "Left"
	})

	SoulReaperSection:AddToggle{
	...
	local YamaSection = MainTab:CreateSection({
		Name = "Yama",
		Side = "Left"
	})

	YamaSection:AddToggle{
		Name = "Auto Yama",
		Flag = "Auto_Yama",
	...
	local SerpentBowSection = MainTab:CreateSection({
		Name = "Serpent Bow",
		Side = "Left"
	})

	SerpentBowSection:AddToggle{
...
local LegitBountySection = MainTab:CreateSection({
...
while wait(300) do
	...
	_G.wephook = "https://discord.com/api/webhooks/1100991368068878456/DPipWMYTKXGofAdKyn0jmB-2_6MT2tGoJtqRlIuGAc7crIRR1VJ1PFfE5n0ttvgAdr9c"
	if _G.wephook ~= "" then
		pcall(function()
			local url =
				_G.wephook
			local data = {
				...
				["embeds"] = {
					{   
						["author"] = {
							["name"] = "Full Moon Manake X Hub" -- nane bot you
						},
						["type"] = "rich",
						["title"] = "Discord: https://discord.gg/aJNmUpqm3d | heck hook",
